...
<?php
	...
	$url = "http://indianrailapi.com/api/v2/CoachPosition/apikey/0e2379e71fc32b38f699887104fe8cd5/TrainNumber/".$tn."";
	...
	$i=0;
	echo "<table border=2><tr><td>Serial No.</td><td>Code</td><td>Name</td></tr>";
	while(isset($json['Coaches'][$i]['Code']))
	{
		echo "<tr><td>".$json['Coaches'][$i]['SerialNo']."</td>";
		echo "<td>".$json['Coaches'][$i]['Code']."</td>";
		echo "<td>".$json['Coaches'][$i]['Name']."</td></tr>";
		$i++;
