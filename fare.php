...
<div class="container">
  ...
  <form class="form" method="get" action="fare1.php">
  <div class="form-group">
    <label for="exampleInputEmail1">Train Number</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tno">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">From</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="from">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">To</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="to">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Quota</label>
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="GN/CK" name="quota">
  </div>
