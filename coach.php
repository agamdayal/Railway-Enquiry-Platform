...
<div class="container">
  ...
  <form class="form" method="get" action="coach1.php">
  
  <div class="form-group">
    <label for="exampleInputPassword1">Train Number</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="tn">
  </div>
