...
<?php
	...
	$url = "http://indianrailapi.com/api/v2/AllTrainOnStation/apikey/0e2379e71fc32b38f699887104fe8cd5/StationCode/".$code."/";
	...
	echo "<table border=2><tr><td>Serial No.</td><td>Train No.</td><td>Train Name</td><td>Source</td><td>Destination</td><td>Departure Time</td><td>Arrival Time</td></tr>";
	$i=0;
	while(isset($json['Trains'][$i]['TrainNo']))
	{
		...
		echo "<td>".$json['Trains'][$i]['ArrivalTime']."</td></tr>";
		$i++;
